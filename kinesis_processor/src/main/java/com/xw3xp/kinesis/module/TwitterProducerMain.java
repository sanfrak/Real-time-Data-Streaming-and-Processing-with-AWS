...
public class TwitterProducerMain {
    ...
    private static TwitterStream createTwitterStream() {
        ...
        cb.setDebugEnabled(true)
                .setOAuthConsumerKey("q16ky8hlDTqzNjYAOhDYueN7M")
                .setOAuthConsumerSecret("4wIJn0Am29pbfZrM59rm6OfQIowGVV9rKK3btEGA8bvbQs4Lqb")
                .setOAuthAccessToken("753278700838203392-W3UFNVp01yDEXEqW7iLXtBcnNGn7IWO")
                .setOAuthAccessTokenSecret("gEcJy2T5M8ErPI6iW9ezf2HXiuswwNXOOciQUOxTOPEk0");
